...
def test_endpoints_module_extracts_public_urls():
    ...
    context.html.return_value = BeautifulSoup('<html><body><a href="/about">About</a><a href="/api/users">API</a><form action="/login"></form><script src="/app.js"></script></body></html>', "lxml")
